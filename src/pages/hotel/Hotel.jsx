        ...
        <div className="flex flex-col gap-8 relative w-full max-w-[1084px]">
          <div className="">
            ...
            <div className="flex flex-col gap-1">
              <span className="font-medium text-[color:var(--secondary-color)]">Valley View - 1.2 KM from bus stand</span>
              <span className="font-medium text-green-600">Book a stay over ₹5,999 at this property and get a free site seeing taxi</span>
            </div>
            <button type="button" className="absolute top-0 right-0 py-3 px-6 text-white font-bold rounded-md bg-[var(--secondary-color)]">Reserve or Book Now!</button>
          </div>
          ...
          <div className="flex justify-center gap-8 p-3">
            <div className="flex-[3] flex flex-col gap-5">
              <h2 className="text-2xl font-black">Stay in the heart of Himalayas</h2>
              <p className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio impedit porro inventore ipsam atque officia cumque corporis ut error, enim repellat deleniti velit ipsa voluptates voluptatum. Unde nulla minima quasi tempore, ad impedit quaerat ipsam iste error eveniet doloremque architecto debitis dolor accusamus necessitatibus, cupiditate exercitationem inventore! Quis eaque esse doloribus, maxime quidem dolorem odit quo, voluptas, mollitia ea officia.</p>
            </div>
            <div className="flex flex-col flex-1 p-6 bg-blue-50">
              <h2 className="text-xl font-black">Perfect for a 9-night stay!</h2>
              <p className="text-sm">Located in the queen of Mountains.Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
              <h3 className="my-5 text-2xl font-extrabold"> <b>₹49,999</b>(9 nights) </h3>
              <button className="font-bold rounded-md bg-[var(--secondary-color)] px-6 py-3 text-white">Reserve or Book now</button>
            </div>
          </div>
          <MailList />
          <Footer />
